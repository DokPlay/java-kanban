 ...
 * Базовая задача.
 *
 * <p>CHANGED (sprint-8): - добавлены поля duration и startTime; - добавлен getEndTime(); -
...
public class Task {
  ...
  /**
   * Возвращает CSV-строку в формате: id,type,name,status,description,durationMinutes,startTime,epic
  ...
  public String toString() {
    return getType()
        ...
        + status
        + ", duration="
        + (duration == null ? "null" : duration.toMinutes() + "m")
        + ", startTime="
        + startTime
        + '}';
  }
