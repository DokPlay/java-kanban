...
/**
 * Общая база для HTTP-обработчиков. Содержит вспомогательные методы.
 * Sprint 9
 */
public abstract class BaseHttpHandler {
    ...
    protected void sendJson(HttpExchange exchange, int status, String json) throws IOException { // sprint 9
